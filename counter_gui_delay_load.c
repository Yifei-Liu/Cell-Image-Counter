 ...
 */
FARPROC WINAPI jiemianDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = jiemianDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = jiemianDelayLoadWin32FailureHook;
#endif
